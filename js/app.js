    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                new swiper_core_Swiper(".gallery-section__slider", {
                    ...
                    on: {
                        beforeInit: function() {
                            if (window.innerWidth < 768) this.params.speed = 600;
                        }
                    }
                });
                new swiper_core_Swiper(".card-with-slider .card-images__slider", {
                    modules: [ Navigation, Pagination, Autoplay ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    pagination: {
                        el: ".card-images__slider .swiper-pagination",
                        clickable: true
                    },
                    navigation: {
                        prevEl: ".card-images__slider .swiper-button-prev",
                        nextEl: ".card-images__slider .swiper-button-next"
                    },
                    on: {
                        beforeInit: function() {
                            if (window.innerWidth < 768) this.params.speed = 600;
                ...
                new swiper_core_Swiper(".activites-items__slider", {
                    ...
                    scrollbar: {
                        el: ".activites-items__slider .swiper-scrollbar",
                        draggable: true,
                        hide: false
                    },
                    navigation: {
                        prevEl: ".activites-items__slider .swiper-button-prev",
                        nextEl: ".activites-items__slider .swiper-button-next"
                    },
                    breakpoints: {
                        320: {
                            slidesPerView: 1.1,
                    ...
                    on: {
                        beforeInit: function() {
                            if (window.innerWidth < 768) {
                                ...
                                this.params.resistance = true;
                                this.params.resistanceRatio = .85;
                            }
                        }
                    }
                });
                new swiper_core_Swiper(".news-items__slider", {
                    modules: [ Navigation, Pagination, Scrollbar ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    scrollbar: {
                        el: ".news-section .swiper-scrollbar",
                        draggable: true,
                        hide: false
                    },
                    navigation: {
...
***************************************************************************** */
        ...
        const galleryItems = {
            0: [ {
                ...
                thumb: "https://picsum.photos/id/10/200/134",
                subHtml: "<h4>Villa</h4><p>Прекрасный вид на виллу</p>"
            }, {
                src: "https://picsum.photos/id/11/1200/800",
                thumb: "https://picsum.photos/id/11/200/134",
                subHtml: "<h4>Villa</h4><p>Интерьер виллы</p>"
            }, {
                src: "https://picsum.photos/id/12/1200/800",
                thumb: "https://picsum.photos/id/12/200/134",
                subHtml: "<h4>Villa</h4><p>Территория виллы</p>"
            }, {
                src: "https://picsum.photos/id/13/1200/800",
                thumb: "https://picsum.photos/id/13/200/134",
                subHtml: "<h4>Villa</h4><p>Вид с террасы</p>"
            } ],
            1: [ {
                src: "https://picsum.photos/id/20/1200/800",
                thumb: "https://picsum.photos/id/20/200/134",
                subHtml: "<h4>General zone</h4><p>Общая зона отдыха</p>"
            }, {
                src: "https://picsum.photos/id/21/1200/800",
                thumb: "https://picsum.photos/id/21/200/134",
                subHtml: "<h4>General zone</h4><p>Бассейн</p>"
            }, {
                src: "https://picsum.photos/id/22/1200/800",
                thumb: "https://picsum.photos/id/22/200/134",
                subHtml: "<h4>General zone</h4><p>Зона барбекю</p>"
            }, {
                src: "https://picsum.photos/id/23/1200/800",
                thumb: "https://picsum.photos/id/23/200/134",
                subHtml: "<h4>General zone</h4><p>Лаунж-зона</p>"
            } ],
            2: [ {
                src: "https://picsum.photos/id/30/1200/800",
                thumb: "https://picsum.photos/id/30/200/134",
                subHtml: "<h4>Happy moments</h4><p>Счастливые моменты</p>"
            }, {
                src: "https://picsum.photos/id/31/1200/800",
                thumb: "https://picsum.photos/id/31/200/134",
                subHtml: "<h4>Happy moments</h4><p>День рождения</p>"
            }, {
                src: "https://picsum.photos/id/32/1200/800",
                thumb: "https://picsum.photos/id/32/200/134",
                subHtml: "<h4>Happy moments</h4><p>Вечеринка</p>"
            }, {
                src: "https://picsum.photos/id/33/1200/800",
                thumb: "https://picsum.photos/id/33/200/134",
                subHtml: "<h4>Happy moments</h4><p>Праздник</p>"
            } ],
            3: [ {
                src: "https://picsum.photos/id/40/1200/800",
                thumb: "https://picsum.photos/id/40/200/134",
                subHtml: "<h4>Bar</h4><p>Барная стойка</p>"
            }, {
                src: "https://picsum.photos/id/41/1200/800",
                thumb: "https://picsum.photos/id/41/200/134",
                subHtml: "<h4>Bar</h4><p>Коктейли</p>"
            }, {
                src: "https://picsum.photos/id/42/1200/800",
                thumb: "https://picsum.photos/id/42/200/134",
                subHtml: "<h4>Bar</h4><p>Бармен за работой</p>"
            }, {
                src: "https://picsum.photos/id/43/1200/800",
                thumb: "https://picsum.photos/id/43/200/134",
                subHtml: "<h4>Bar</h4><p>Винная карта</p>"
            } ]
        };
        const customIcons = {
            close: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18 6L6 18" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 6L18 18" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            prev: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15 18L9 12L15 6" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            next: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9 18L15 12L9 6" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'
        };
        const photoItems = document.querySelectorAll(".gallery-photos__item");
        if (photoItems.length) photoItems.forEach(((item, index) => {
            item.addEventListener("click", (function(e) {
                e.preventDefault();
                const galleryData = galleryItems[index] || [];
                if (galleryData.length) {
                    const dynamicGallery = lightgallery_es5(document.createElement("div"), {
                        dynamic: true,
                        dynamicEl: galleryData,
                        download: false,
                        plugins: [ lg_zoom_min, lg_pager_min ],
                        licenseKey: "7EC452A9-0CFD441C-BD984C7C-17C8456E",
                        speed: 500,
                        pager: true,
                        closeSvg: customIcons.close,
                        prevHtml: customIcons.prev,
                        nextHtml: customIcons.next,
                        mobileSettings: {
                            controls: true,
                            showCloseIcon: true,
                            download: false
                        },
                        addClass: "moonrock-gallery",
                        actualSize: false
                    });
        ...
        function initLettersReveal() {
            const textElements = document.querySelectorAll(".animate-letters-reveal");
            if (textElements.length) textElements.forEach((element => {
        ...
        function initCustomAnimations() {
            const watchElements = document.querySelectorAll("[data-watch], [data-watch-once]");
            const observer = new IntersectionObserver(((entries, observer) => {
                entries.forEach((entry => {
                    if (entry.isIntersecting) {
                        const element = entry.target;
                        activateAnimations(element);
                        if (element.hasAttribute("data-watch-once")) observer.unobserve(element);
                    } else if (!entry.target.hasAttribute("data-watch-once")) deactivateAnimations(entry.target);
                }));
            }), {
                threshold: .15,
            ...
            function activateAnimations(parentElement) {
                const animElements = parentElement.querySelectorAll('[class*="animate-"]');
                animElements.forEach((element => {
                    element.classList.add("animated");
                }));
                const staggerParents = parentElement.querySelectorAll(".animate-stagger-children");
                staggerParents.forEach((parent => {
                    parent.classList.add("stagger-animated");
                    const children = parent.children;
                    Array.from(children).forEach(((child, index) => {
                        child.style.transitionDelay = `${(index + 1) * .1}s`;
                        child.classList.add("stagger-item-animated");
                    }));
                }));
                const staggerItems = parentElement.querySelectorAll(".animate-stagger-item");
                staggerItems.forEach(((item, index) => {
                    item.style.transitionDelay = `${(index + 1) * .1}s`;
                    item.classList.add("animated");
                }));
            }
            function deactivateAnimations(parentElement) {
                const animElements = parentElement.querySelectorAll('[class*="animate-"]');
                animElements.forEach((element => {
                ...
                const staggerParents = parentElement.querySelectorAll(".animate-stagger-children");
                staggerParents.forEach((parent => {
                    parent.classList.remove("stagger-animated");
                    const children = parent.children;
                    Array.from(children).forEach((child => {
                        child.style.transitionDelay = "";
                        child.classList.remove("stagger-item-animated");
                    }));
                }));
                const staggerItems = parentElement.querySelectorAll(".animate-stagger-item");
        ...
        headerScroll();
        document.addEventListener("DOMContentLoaded", (function() {
            const marquee = document.querySelector(".stripe__marquee");
            if (!marquee) return;
            const lists = marquee.querySelectorAll(".stripe__list");
            function setupMarquee() {
                lists.forEach((list => {
                    const items = Array.from(list.querySelectorAll(".stripe__item"));
                    Array.from(items).reduce(((width, item) => width + item.offsetWidth), 0);
                    const containerWidth = marquee.offsetWidth;
                    while (list.scrollWidth < containerWidth * 2) items.forEach((item => {
            ...
            const handleVisibility = () => {
                ...
                lists.forEach((list => {
                    list.style.animationPlayState = isVisible ? "running" : "paused";
                }));
            };
            setupMarquee();
